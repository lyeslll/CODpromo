  ...
  return (
    <div className="relative grid min-h-screen place-items-center overflow-hidden bg-[var(--color-ink)] px-4 py-10 text-[var(--text)]">
      ...
      <motion.div
        ...
        className="relative w-full max-w-md rounded-[var(--radius-card)] border border-[var(--color-ink-line)] bg-[var(--color-ink-card)] p-7 shadow-[0_24px_70px_-30px_rgba(0,0,0,0.55)]"
      >
